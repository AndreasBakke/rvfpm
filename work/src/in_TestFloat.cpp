/**
 * 
 * Wrapper to Berkley TestFloat
 * Partly generated by chatGPT (Convertion functions)
 * Prompts: 
 *    Can you write me two c++ function to convert a floating point value to hex and vice versa?
 * 
 *    Given a unsigned int where the last 5 bit indicates flags raised, can you write me a function to reverse the order of the bits, and write as hex?
*/
...
//Following function generated by ChatGPT
//Prompt: Can you write yet another to translate from uint32_t to hex string?
